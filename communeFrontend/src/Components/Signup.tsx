          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
              ...
              <img className="w-12 h-12 block ml-auto mr-auto "  src={logoWizara} alt="logo"/>
                  ...
                  <form className="space-y-4 md:space-y-6" action="#" method="post" onSubmit={onSubmitForm}>
                      ...
                      <button type="submit" className="w-full disabled:opacity-50 disabled:cursor-default text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"  onClick={()=>console.log("WHEN CLICKED ON SIGNUP : ",user)} disabled={!(user.cin===CIN)}>S'Inscrire</button>
                      <button type="button" className="w-full disabled:opacity-50 disabled:cursor-default text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"  onClick={()=>{handleModalOpen()}} disabled={user.cin.length==0}>Vérifier identité</button>
